      ...
      child: Padding(
        ...
        child: Column(
          children: [
            Row(
              children: [
                cardIconFrom(Icons.thermostat, colorScheme),
                const SizedBox(
                  width: 10,
                ),
                Text(
            ...
            AspectRatio(
              aspectRatio: 1.8,
              child: LineChart(_getChartDataFromForecast(
                  dailyForecast, colorScheme, textTheme)),
            ),
          ],
        ),
      ),
...
LineChartData _getChartDataFromForecast(
    DailyForecast dailyForecast, ColorScheme colorScheme, TextTheme textTheme) {
    ...
    lineBarsData: [
      _getLineChartBarData(
          ...
          (previousValue, element) => [
                ...previousValue,
                FlSpot(previousValue.length.toDouble(), element.maxTemperature)
              ],
          dailyForecast),
      _getLineChartBarData(
          Colors.blue,
          (previousValue, element) => [
                ...previousValue,
                FlSpot(previousValue.length.toDouble(), element.minTemperature)
              ],
          dailyForecast),
    ],
      ...
      bottomTitles: AxisTitles(
        sideTitles: SideTitles(
          ...
          getTitlesWidget: (value, meta) {
            final nextDate = startingDate.add(Duration(days: value.toInt()));
